            ...
            tbar: [
                ...
                new Ext.form.ComboBox({
                    ...
                    store: new Ext.data.SimpleStore({
                        fields: ['id', 'name'],
                        data: [['0.1', '10%'], ['0.25', '25%'], ['0.5', '50%'], ['1', '100%'], ['2', '200%'], ['3', '300%']]
                    }),
                    width: 60,
                    triggerAction: 'all',
                    mode: 'local',
    ...
    afterRender: function () {
        ...
        this.imageMap = new imgmap({
            ...
            custom_callbacks: {
                ...
                'onRemoveArea': function (obj) { this.onRemoveArea(obj); }.bind(this),//to remove form elements from gui
        ...
        this.editWin = new Ext.Window({
            ...
            items: [new Ext.form.FormPanel({
                ...
                items: [
					...
					//	store : new Ext.data.SimpleStore({
					//		fields: ['id', 'name'],	
					//		data: [['rect', 'Rectangle'],['circle', 'Circle'],['poly', 'Polygon']]
					//	}),
					//	triggerAction: 'all',
					//	mode: 'local',
					//	allowBlank: true,
                	...
                	//},
    				{
    				    ...
    				    name: 'img_title',
    				    enableKeyEvents: true,
    				    value: unescape(this.imageMap.areas[obj.aid].atitle),
    				    allowBlank: true,
    				    listeners: {
    				        keyup: function (field, event) {
    				            this.inputChange(field, obj.aid);
                    ...
                    //                var combo = Ext.getCmp('FeedbackItem');
                    //                combo.setValue(this.imageMap.areas[obj.aid].atarget);
                    //            }.bind(this)
                    //        }
                    //    }),
                    //    triggerAction: 'all',
